...
abs_deca_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', 'downloads'))
cfg.deca_dir = abs_deca_dir
cfg.device = 'cuda'
cfg.device_id = '0'

cfg.pretrained_modelpath = os.path.join(cfg.deca_dir, 'FLAME', 'deca_model.tar')
cfg.output_dir = ''
...
# ---------------------------------------------------------------------------- #
cfg.model = CN()
cfg.model.topology_path = os.path.join(cfg.deca_dir, 'FLAME', 'head_template.obj')
# texture data original from http://files.is.tue.mpg.de/tbolkart/FLAME/FLAME_texture_data.zip
cfg.model.dense_template_path = os.path.join(cfg.deca_dir, 'FLAME', 'texture_data_256.npy')
cfg.model.fixed_displacement_path = os.path.join(cfg.deca_dir, 'FLAME', 'fixed_displacement_256.npy')
cfg.model.flame_model_path = os.path.join(cfg.deca_dir, 'FLAME', 'generic_model.pkl') 
cfg.model.flame_lmk_embedding_path = os.path.join(cfg.deca_dir, 'FLAME', 'landmark_embedding.npy') 
cfg.model.face_mask_path = os.path.join(cfg.deca_dir, 'FLAME', 'uv_face_mask.png') 
cfg.model.face_eye_mask_path = os.path.join(cfg.deca_dir, 'FLAME', 'uv_face_eye_mask.png') 
cfg.model.mean_tex_path = os.path.join(cfg.deca_dir, 'FLAME', 'mean_texture.jpg') 
cfg.model.tex_path = os.path.join(cfg.deca_dir, 'FLAME', 'FLAME_albedo_from_BFM.npz') 
...
cfg.model.fr_model_path = os.path.join(cfg.deca_dir, 'FLAME', 'resnet50_ft_weight.pkl')
